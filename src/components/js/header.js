...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className=" h-20	relative  bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-500  w-full flex md:flex-row items-center justify-center  gap-10 transition ease-in delay-300 duration-700">
