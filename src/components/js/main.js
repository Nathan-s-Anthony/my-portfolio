...
const Main = () => {
    ...
    return (
        ...
        <main className=" min-w-full relative h-full " >
            <div onClick={scrollToTop} className={scroll ? "fixed bottom-2 right-2 bg-blue-500 rounded-full p-3 z-50 cursor-pointer" : " fixed none"}><ArrowNarrowUpIcon className="w-8 h-8 text-white text-xl" /></div>
                    ...
                    <div className="w-full h-full flex flex-col md:flex-row justify-center relative align-center items-center  ">
                        <div className="w-full h-full flex flex-col md:flex-row align-center  items-center lg:items-end relative justify-center lg:justify-end md:mr-10 md:ml-10 lg:mb-0 lg:mt-10 mb-10 ">
                            <div className="relative  ">
                                ...
                                <Images arrI="0" arrO="0" alt="Nathan Anthony" borderRadius="full" />
            ...
            <section className="  relative  w-full lg:h-full   py-10">
                <div className="  w-full h-full bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-500  transform -skew-y-2 relative p-20">
                    <div className="  w-full     relative transform skew-y-2 z-20" id="about">
            ...
            <section className="  relative  w-full lg:h-full   py-10">
                <div className="  w-full h-full relative p-20">
                    <div className="  w-full     relative transform  z-20" id="about">
                        <div className="  flex  flex-wrap md:flex-row  w-full   md:container mx-auto justify-center items-center   z-30">
                            <div className=" md:text-left text-center flex flex-col  items-center justify-evenly gap-5 container ">
                                <h2 className=" lg:text-center text-md font-extrabold lg:text-lg text-center container  lg:py-2 lg:px-6 text-textPrimary "  >My projects<span className="ml-2">📝</span></h2>
                                <h3 className=" lg:text-center text-center text-5xl xl:text-6xl  font-extrabold lg:py-2 lg:px-6  text-transparent text-textPrimary  tracking-wide   ">My Skills</h3>
                                <p className="   text-center text-md lg:text-md  container  lg:py-2 lg:px-6  text-textPrimary   ">   Each project requirements are unique making them require different technologies,frameworks or libraries to accomplish. </p>
            ...
            <section className="  relative  w-full lg:h-full   py-10">
                <div className="  w-full h-full relative p-20">
                    <div className="  w-full     relative transform  z-20" id="about">
                        <div className="  flex  flex-wrap md:flex-row  w-full   md:container mx-auto justify-center items-center   z-30">
                            <div className=" md:text-left text-center flex flex-col  items-center justify-evenly gap-5 container ">
                                <h2 className=" lg:text-center text-md font-extrabold lg:text-lg text-center container  lg:py-2 lg:px-6 text-textPrimary "  >My Blog<span className="ml-2">📝</span></h2>
                                <h3 className=" lg:text-center text-center text-5xl xl:text-6xl  font-extrabold lg:py-2 lg:px-6  text-transparent text-textPrimary tracking-wide   ">My Skills</h3>
                                <p className="   text-center text-md lg:text-md  container  lg:py-2 lg:px-6  text-textPrimary   "> Whether you an experienced developer or someone starting their journey into web development ,  </p>
                        ...
                        <article className="max-w-sm rounded overflow-hidden shadow-lg">
                            <div className="relative w-full h-40">
                                <Images arrI="4" arrO="0" alt="Nathan Anthony" borderRadius="none" />
                            </div>
                            ...
                            <div className="px-6 pt-4 pb-2">
                                ...
                                <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#bestPractices</span>
                            </div>
            ...
            <footer className="relative  flex  flex-wrap lg:flex-row  w-full  mx-auto bg-textPrimary  justify-start items-start flex-col lg:mb-20 lg:mt-20  ">
                <h4 classname="text-white">Created with React & TailwindCSS <span>coffee</span> and  <span className="color-transparent w-10 h-10 text-lg  animate-pulse text-center mx-auto"> 💓 </span>by Nathan Anthony</h4>
            </footer>
        </main>
