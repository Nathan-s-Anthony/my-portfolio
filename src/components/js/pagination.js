    ...
    return (
        <div className="  bg-transparent w-32 h-3/6  right-0 top-0  flex flex-col flex-nowrap content-center justify-center items-center z-0 ">
            <div className="bg-transparent h-60 flex flex-col flex-nowrap content-center items-center justify-center ">
                ...
                <div className={tooltip ? "relative w-12 h-12 bg-gray-300 rounded-full transform transition duration-500 hover:scale-125":"relative w-4 h-4 cursor-pointer bg-gray-300 rounded-full mt-2 mb-2"}>      </div>
                <div className={tooltip ? "relative w-12 h-12 bg-gray-300 rounded-full transform transition duration-500 hover:scale-125":"relative w-4 h-4 cursor-pointer bg-gray-300 rounded-full -10  mt-2 mb-2"}></div>
                <div className={tooltip ? "relative w-12 h-12 bg-gray-300 rounded-full transform transition duration-500 hover:scale-125":"relative w-4 h-4 cursor-pointer bg-gray-300 rounded-full   mt-2 mb-2"}></div>
